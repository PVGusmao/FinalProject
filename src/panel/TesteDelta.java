...
public class TesteDelta {
	...
	public static void main(String[] args) {
		...
		if (sub == 2) {
			double[][] matrix = createMatrixDeltaDois(h, r, s, n, subconductorDistance, t, sub, xP1, yP1, xP2, yP2, rpr);
            ...
            double realAtGround = groundFieldFormulaDelta(RealLoadMatrix, pointPtoA, pointPtoB, pointPtoC, h, n, s, t, sub, xP1, xP2, yP1, yP2);
            double imaginaryAtGround = groundFieldFormulaDelta(ImaginaryLoadMatrix, pointPtoA, pointPtoB, pointPtoC, h, n, s, t, sub, xP1, xP2, yP1, yP2);
			...
			double[][] matrix = createMatrixDeltaTres(h, r, s, n, subconductorDistance, t, sub, xP1, yP1, xP2, yP2, rpr);
			...
			double[][] matrix = createMatrixDeltaQuatro(h, r, s, n, subconductorDistance, t, sub, xP1, yP1, xP2, yP2, rpr);
        	double invertedMatrix[][] = invert(matrix);
            double rMatrix[] = realVoltage(tension, 120, n, sub);  
            double iMatrix[] = imaginaryVoltage(tension, 120, n, sub);
            double RealLoadMatrix[][] = multiplyMatrix(invertedMatrix,  rMatrix, n, sub);
			...
			double[][] matrix = createMatrixDeltaCinco(h, r, s, n, subconductorDistance, t, sub, xP1, yP1, xP2, yP2, rpr);
        	double invertedMatrix[][] = invert(matrix);
            double rMatrix[] = realVoltage(tension, 120, n, sub);  
            double iMatrix[] = imaginaryVoltage(tension, 120, n, sub);
            double RealLoadMatrix[][] = multiplyMatrix(invertedMatrix,  rMatrix, n, sub);
	 ...
	 public double angle(double t, double dff) {
		 ...
		 public static Conductor[] distribuiDelta (int n, int sub, double d, double h, double r, double s, double xP1, double yP1, double xP2, double yP2, double t) {
		 ...
		 public static double[][] createMatrixDeltaCinco (double h, double r, double s, int n, double d, double t, int sub, double xP1, double yP1, double xP2, double yP2, double rpr) {
		 ...
		 public static double[][] createMatrixDeltaQuatro (double h, double r, double s, int n, double d, double t, int sub, double xP1, double yP1, double xP2, double yP2, double rpr) {
		        double matrix[][] = new double[sub * n+2][sub * n+2];
		 ...
		 public static double[][] createMatrixDeltaTres (double h, double r, double s, int n, double d, double t, int sub, double xP1, double yP1, double xP2, double yP2, double rpr) {
		        double matrix[][] = new double[sub * n+2][sub * n+2];
		 ...
		 public static double[][] createMatrixDeltaDois (double h, double r, double s, int n, double d, double t, int sub, double xP1, double yP1, double xP2, double yP2, double rpr) {
	     double matrix[][] = new double[sub * n+2][sub * n+2];
		 ...
		 public static double[][] invert(double a[][]) {
			 ...
			 public static double groundFieldFormulaDelta(double a[][], double dh1, double dh2, double dh3, double h, int n, double dff, double t, int sub, double xP1, double xP2, double yP1, double yP2) {
			    	...
			    	for(int i = 0; i <(sub * n + 2); i++) {
			    		...
			    		} else if (i >=2*sub && i < n*sub ) {
			    			GroundValue0 += epsilon * 2 * ((a[i][j] * h)/(Math.pow(dh[i], 2) + Math.pow(h, 2)));
			    		} else if (i == n*sub) {
			    			GroundValue0 += epsilon * 2 * ((a[i][j] * yP1)/(Math.pow(dh[i], 2) + Math.pow(yP1, 2)));
			    		} else if (i == n*sub+1) {
			    			GroundValue0 += epsilon * 2 * ((a[i][j] * yP2)/(Math.pow(dh[i], 2) + Math.pow(yP2, 2)));
			    		}
			    	}
			    	return GroundValue0;
			    }
